                      ...
                      export class PostPage {
                        ...
                        constructor(public navCtrl: NavController,public modalCtrl: ModalController,public actionSheetCtrl: ActionSheetController,private geolocation: Geolocation,private camera: Camera ,public alertCtrl: AlertController,public toastCtrl: ToastController,public appsetting: Appsetting,public loadingCtrl:LoadingController, public http:Http) {
                          this.geoloc();
                          this.categoryy();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    let Loading=this.loadingCtrl.create({
                      ...
                      Loading.present();
                        if(sell == '' || brief == '' || priceadv == '' || this.list_one == ''  ||  this.images == '' || this.cat_name == '' || priceadv == undefined){
                        Loading.dismiss();    
                          ...
                          let toast = this.toastCtrl.create({
                            ...
                            position: 'middle'
                              ...
                              toast.present();
                        }else if(this.folderpic == '' || this.folderpic == undefined){
                          Loading.dismiss(); 
                          let toast = this.toastCtrl.create({
      ...
      // subTitle: 'Would you like to post advertisemnet for?',
      // cssClass: 'popup_head',
            ...
            let headers = new Headers();
                          ...
                          this.http.get(urlpack , options).map(res=>res.json()).subscribe(data=>{
                              console.log(data);
                                ...
                                for(var i=0; i < data.packagelist.length ; i++){
                                            if(data.packagelist[i].title == this.button2){
                                              console.log(data.packagelist[i].title);
                                              this.pack_id = data.packagelist[i].id;
                                              console.log(this.pack_id);
                                              this.pack_price = data.packagelist[i].price;
